  ...
  return (
    <div className='flex justify-between items-center p-5 fixed z-20 w-full top-0 bg-green-500'>
      ...
      <div className='hidden sm:block'>
        <Link to="/order">
          <button  className="bg-blue-600 font-bold hover:bg-yellow-400 py-2 px-5  text-black hover:text-white md:text-2xl text-xl rounded-full mr-10">Order now</button>
        </Link>
      </div>
    </div>
    );
